...
fun attachMendixSupportManagerShakeDetector(shakeDetector: ShakeDetector, devSupportManager: DevSupportManager?): Unit = devSupportManager.let { supportManager ->
    val devShakeDetector = ReflectionUtils.getFieldOfSuperclass<ShakeDetector>(supportManager, SHAKE_DETECTECTOR_VAR)
