...
fun setBundleDownloadListener(devSupportManager: DevSupportManager?, listener: DevBundleDownloadListener) {
    devSupportManager?.apply {
        ReflectionUtils.setFieldOfSuperclass(this, "mBundleDownloadListener", listener)
    }
}

fun overrideDevLoadingViewController(devSupportManager: DevSupportManager, devLoadingViewController: DefaultDevLoadingViewImplementation) {
    devSupportManager.apply {
