...
fun mapErrorHandlerToRedBox(errorHandler: ErrorHandler) = object : RedBoxHandler {
    override fun handleRedbox(title: String?, stack: Array<out StackFrame>?, errorType: ErrorType?) = errorHandler.handleError(title, stack, fromReactErrorType(errorType))
