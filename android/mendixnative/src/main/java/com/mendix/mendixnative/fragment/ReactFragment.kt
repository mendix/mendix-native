...
open class ReactFragment : Fragment(), PermissionAwareActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mReactDelegate = ReactDelegate(activity, reactNativeHost, mainComponentName, launchOptions)
    }
    ...
    protected val reactNativeHost: ReactNativeHost
        protected get() = (requireActivity().application as ReactApplication).reactNativeHost
    ...
    override fun requestPermissions(
            permissions: Array<out String>, requestCode: Int, listener: PermissionListener?) {
